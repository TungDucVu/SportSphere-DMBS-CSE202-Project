...
orders DeliveryAgentID is INT Default NULL: newly generated ordered will not yet assigned to an agent
create a trigger that auto assign agent to order with null agent if his status is "available"
*/
...
UPDATE Customer
SET first_name = 'NewFirstName', last_name = 'NewLastName', street = 'New Street', city = 'New City', state = 'New State', pincode = 123456 -- Change which should be done as needed
WHERE Customer_ID = 1;  -- Change Customer_ID as needed

-- 13. Price Drop Alert
/*
create product history table: id, product, old price, new price, changed date
create a trigger to store old price
query from this table: select product from this table where new price < old price
*/